      ...
      <Head><title>Moni's Portfolio</title></Head>
        <div className='bg-gradient-to-t from-gray-800 via-gray-900 to-black h-full'>
          <header className="text-gray-400 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center border-b-[3px] border-gray-500 ">
              ...
              <nav className="md:ml-auto flex gap-2 flex-wrap items-center text-base justify-center">
                <a className="mr-5 text-2xl cursor-pointer hover:text-pink-400"><BsGithub /></a>
                <a className="mr-5 text-2xl cursor-pointer hover:text-pink-400"><BsLinkedin/></a>
                <a className="mr-5 text-2xl cursor-pointer hover:text-pink-400"><BsTwitter/></a>
                <a className="mr-5 text-2xl cursor-pointer hover:text-pink-400"><AiTwotoneMail/></a>
                <a className="mr-5 text-2xl cursor-pointer hover:text-pink-400"><BsInstagram/></a>
                <a className="mr-5 text-2xl cursor-pointer hover:text-pink-400"><BsReddit/></a>
              </nav> 
          ...
          <section className="ml-[120px] mt-[40px] text-gray-400">
            <h1 className=' font-medium text-[60px] font-body uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-700 via-pink-300 to-violet-300'>Soumyadip Moni</h1>
          ...
          <section className='ml-[120px] mt-[80px]'>
            <h2 className='uppercase text-[30px] my-7 text-gray-400 '>Activities</h2>
            <div className='uppercase'>
              <h3 className='text-gray-400 text-lg'>Student</h3>
              <div>
                <div className='mt-3  font-bold '>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>2007</span>
                  <span className='text-gray-100'> {">"} </span>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px]  border rounded-lg'>Today</span>
                </div>
              </div>
              <h3 className='text-gray-400 mt-6 text-lg'>Frontend Developer</h3>
              <div>
                <div className='mt-3  font-bold'>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>2020</span>
                  <span className='text-gray-100'> {">"} </span>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>Today</span>
                </div>
              </div>
              <h3 className='text-gray-400 mt-6 text-lg'>Fullstack Developer</h3>
              <div>
                <div className='mt-3  font-bold mb-5'>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>2022</span>
                  <span className='text-gray-100'> {">"} </span>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>Today</span>
                </div>
              </div>
              ...
              <div>
                <div className='mt-3  font-bold mb-5'>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>2023</span>
                  <span className='text-gray-100'> {">"} </span>
                  <span className='bg-pink-300 text-gray-900 text-sm px-2 py-[5px] border rounded-lg'>Today</span>
                </div>
              </div>
